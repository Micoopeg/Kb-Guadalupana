...
{
    public partial class MantenimientoEstatus : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            RECodigo.Value = logic.siguiente("ep_tipoestatuscuenta", "codeptipoestatuscuenta");
            RECodigo.Disabled = false;
        }
        ...
        protected void gvPhoneBook_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName.Equals("AddNew"))
                {
                    ...
                    {
                        sqlCon.Open();
                        string query = "INSERT INTO ep_tipoestatuscuenta (codeptipoestatuscuenta,ep_tipoestatuscuentanombre) VALUES (@FirstName,@Contact)";
        ...
        protected void gvPhoneBook_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                ...
                {
                    sqlCon.Open();
                    string query = "UPDATE ep_tipoestatuscuenta SET codeptipoestatuscuenta=@FirstName,ep_tipoestatuscuentanombre=@Contact WHERE codeptipoestatuscuenta = @id";
                    MySqlCommand sqlCmd = new MySqlCommand(query, sqlCon);
        ...
        protected void gvPhoneBook_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                {
                    sqlCon.Open();
                    string query = "DELETE FROM ep_tipoestatuscuenta WHERE codeptipoestatuscuenta = @id";
                    MySqlCommand sqlCmd = new MySqlCommand(query, sqlCon);
                    sqlCmd.Parameters.AddWithValue("@id", Convert.ToInt32(gvPhoneBook.DataKeys[e.RowIndex].Value.ToString()));
                    sqlCmd.ExecuteNonQuery();
                    PopulateGridview();
        ...
        {
            MySqlDataAdapter ad = new MySqlDataAdapter("SELECT * FROM ep_tipoestatuscuenta;", conn.conectar());
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                string QueryString = "SELECT * FROM ep_tipoestatuscuenta WHERE ep_tipoestatuscuentanombre='" + TextBox1.Text + "';";
                MySqlDataAdapter myCommand = new MySqlDataAdapter(QueryString, conn.conectar());
                DataTable ds3 = new DataTable();
                myCommand.Fill(ds3);
                gvPhoneBook.DataSource = ds3;
