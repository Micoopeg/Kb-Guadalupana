<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MantenimientoMoneda.aspx.cs" Inherits="KB_Guadalupana.Views.Sesion.MantenimientoMoneda" %>
...
<body>
    ...
    <div class="encabezado">
         <h2 class="fs-title" style="margin-left:0">
            <b>Registro Tipo Moneda</b>
        </h2>
        <img src="../../Imagenes/Logotipo-Guadalupana1.png" style="width: 118px; height: 91px; top: 0; margin-left: 0px;" />
     </div>

    <input id="RMCodigo" disabled="disabled" readonly="readonly" runat="server" type="text" class="tam" style="width:10%;" maxlength="15" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required/>
    <div class="buscar">
    <asp:TextBox ID="TextBox1" placeholder="Ingrese tipo moneda" runat="server" CssClass="tamp"></asp:TextBox>
    ...
    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Ver todos" CssClass="tam" />
        ...
        <asp:GridView ID="gvPhoneBook" CssClass="tabla" runat="server"  AutoGenerateColumns="false" ShowFooter="true" DataKeyNames="codeptipomoneda"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Código">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("codeptipomoneda") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtFirstName" Text='<%# Eval("codeptipomoneda") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                  ...
                  <ItemTemplate>
                            <asp:Label Text='<%# Eval("ep_tipomonedanombre") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtContact" Text='<%# Eval("ep_tipomonedanombre") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtContactFooter" placeholder="Ingrese tipo moneda" runat="server" />
                        </FooterTemplate>
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="Signo">
                  <ItemTemplate>
                            <asp:Label Text='<%# Eval("ep_signomoneda") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtContact2" Text='<%# Eval("ep_signomoneda") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtContactFooter2" placeholder="Ingrese signo" runat="server" />
                        </FooterTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Código Internacional">
                  <ItemTemplate>
                            <asp:Label Text='<%# Eval("ep_codigointernacional") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtContact3" Text='<%# Eval("ep_codigointernacional") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtContactFooter3" placeholder="Ingrese código internacional" runat="server" />
                        </FooterTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <ItemTemplate>
