<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MantenimientoEstatus.aspx.cs" Inherits="KB_Guadalupana.Views.Sesion.MantenimientoEstatus" %>
   ...
   <div>
    <div class="encabezado">
         <h2 class="fs-title" style="margin-left:0">
            <b>Registro Tipo Estatus Cuentas</b>
        </h2>
    ...
    <div class="buscar">
    <asp:TextBox ID="TextBox1" placeholder="Ingrese tipo estatus" runat="server" CssClass="tamp"></asp:TextBox>
    ...
    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Ver todos" CssClass="tam" />
       ...
       <asp:GridView ID="gvPhoneBook" CssClass="tabla" runat="server" AutoGenerateColumns="false" ShowFooter="true" DataKeyNames="codeptipoestatuscuenta"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Código">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("codeptipoestatuscuenta") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtFirstName" Text='<%# Eval("codeptipoestatuscuenta") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtFirstNameFooter" runat="server"/>
                        </FooterTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Tipo Estatus Cuentas">
                  <ItemTemplate>
                            <asp:Label Text='<%# Eval("ep_tipoestatuscuentanombre") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtContact" Text='<%# Eval("ep_tipoestatuscuentanombre") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtContactFooter" placeholder="Ingrese tipo estatus" runat="server" />
                        </FooterTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <ItemTemplate>
