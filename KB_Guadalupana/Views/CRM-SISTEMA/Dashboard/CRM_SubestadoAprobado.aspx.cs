...
{
    public partial class CRM_SubestadoAprobado : System.Web.UI.Page
    {
        ...
        {
            DataSet ds1 = sn.consultarsubestadosasprobado(); //vonsulta las tareas del agente en fecha actual
