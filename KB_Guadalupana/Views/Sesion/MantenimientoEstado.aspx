<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MantenimientoEstado.aspx.cs" Inherits="KB_Guadalupana.Views.Sesion.MantenimientoEstado" %>
...
<body>
    ...
    <a class="button button5" style="right: 8%;position: absolute;margin-top: -500px;" target="_blank" href="Ayudas/AyudaEstado.aspx" ><i class="fa fa-question"></i></a>
    ...
    <div class="encabezado">
        <h2 class="fs-title" style="margin-left:0">
            <b>Registro Tipo Estado</b>
        </h2>
        <img src="../../Imagenes/Logotipo-Guadalupana1.png" style="width: 180px; height: 120px; top: 0; margin-left: 0px;" />
     </div>
        <input id="RECodigo" disabled="disabled" readonly="readonly" runat="server" type="text" class="tam" style="width:10%;" maxlength="15" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required/>

   <div class="buscar">
    <asp:TextBox ID="TextBox1" placeholder="Ingrese tipo estado" runat="server" CssClass="tamp"></asp:TextBox>
    ...
    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Ver todos" CssClass="tam" />
      ...
      <asp:GridView ID="gvPhoneBook" CssClass="tabla" runat="server" AutoGenerateColumns="false" ShowFooter="true" DataKeyNames="codeptipoestado"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Código">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("codeptipoestado") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtFirstName" Text='<%# Eval("codeptipoestado") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtFirstNameFooter" runat="server"/>
                        </FooterTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Tipo Estado">
                  <ItemTemplate>
                            <asp:Label Text='<%# Eval("ep_tipoestadonombre") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtContact" Text='<%# Eval("ep_tipoestadonombre") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtContactFooter" placeholder="Ingrese tipo estado" runat="server" />
                        </FooterTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <ItemTemplate>
