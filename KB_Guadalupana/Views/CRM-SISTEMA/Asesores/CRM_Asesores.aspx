            ...
            <div class="wrapper">
                <div style="border: 1px #e8e8e8 solid; width: 100%; height: 1148px; float: right; margin: 10px 0px 10px 0px">
                    ...
                    <div style="padding: 2px; font-size: 13px;">
                        ...
                        <span style="margin-left: 1%; font-size:16px">Q</span><input id="txtingreso" onkeypress="return solonumeros(event);" style="width: 25%" placeholder="Q - Ingresos" runat="server" type="text" tabindex="5" class="inputscortos" autofocus="autofocus" />
                        <span style="margin-left: 5%">Egresos:</span>
                        <span style="margin-left: 1%; font-size:16px">Q</span><input id="txtegresos" onkeypress="return solonumeros(event);" style="width: 25%" placeholder="Q - Egresos" runat="server" type="text" tabindex="6" class="inputscortos" autofocus="autofocus" />
                    </div>
                    <div style="padding: 2px; font-size: 13px;">
                        <%-- AREA DE EMPLEADOS --%>
                    ...
                    <div style="padding: 1px; font-size: 13px;">
                        ...
                        <span style="margin-left: 1%; font-size:16px">Q</span><input id="txtmonto" style="width: 8%;" placeholder="Q - Monto" runat="server" type="text" tabindex="11" class="inputscortos" autofocus="autofocus"/>
