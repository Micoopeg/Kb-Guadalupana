<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SQ_Preguntas.aspx.cs" Inherits="KB_Guadalupana.Views.Evaluaciones.SQ_Preguntas" %>
...
<head runat="server">
    ...
    <title>Mantenimiento de Pregunta</title>
</head>
<body>
    <form id="form1" runat="server">
     ...
     <asp:LinkButton ID="btnpreguntas" runat="server" CssClass="custom-btn btn-8" Text="ingresar" OnClick="btnpuestos_Click"> </asp:LinkButton>
