    ...
    <div class="container">   
        <div class="row">
                        ...
                        <div class="col" style=" text-align:right" >
                         <asp:Button ID="btncerrasesion" style="text-align:right;color:white;" BackColor="#69a43c" Width="100%" Height="100%" runat="server" Text="Cerrar Sesión" BorderStyle="None" OnClick="btncerrasesion_Click" />                    
                        </div>
