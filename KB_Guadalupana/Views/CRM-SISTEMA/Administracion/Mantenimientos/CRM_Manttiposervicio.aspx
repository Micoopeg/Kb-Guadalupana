<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRM_Manttiposervicio.aspx.cs" Inherits="CRM_Guadalupana.Views.CRM_SISTEMA.Administracion.Mantenimientos.CRM_Manttiposervicio" %>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-8">
      <h3>REGISTROS</h3>
        <asp:Label runat="server">Tipo de servicio:</asp:Label><input id="txtbusqueda" runat="server" placeholder="BUSCAR POR NOMBRE" style="margin-left:2%" /><asp:LinkButton runat="server" style="margin-left:2%; border-style:none; color:white" ID="btnbuscar" OnClick="btnbuscar_Click">Buscar</asp:LinkButton><br />
    ...
    AutoGenerateColumns="False" OnSelectedIndexChanged = "OnSelectedIndexChangedmantenimiento" BorderStyle="Solid" Width="100%" AllowPaging="True" OnPageIndexChanging="gridviewmantenimiento_PageIndexChanging" PageSize="3" >                 
                     <Columns>
                         <asp:TemplateField HeaderText="Correlativo">
                           <ItemTemplate>
                            <asp:Label ID="lblcodigo" Text='<%# Eval("codcrmtiposervicio") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                         <asp:TemplateField HeaderText="Nombre - Descripción">
                           <ItemTemplate>
                            <asp:Label ID="lblnombre" Text='<%# Eval("crmtipo_servicionombre") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>                         
