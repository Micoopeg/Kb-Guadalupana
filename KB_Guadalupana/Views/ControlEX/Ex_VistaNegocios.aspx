	...
	<nav class="nav">
		...
		<li class="li">
         ...
         <div class="row">
           ...
           <span id="span" runat="server" style="font-size:15px">Numero de credito </span> <asp:DropDownList ID="dgvnumcred" runat="server" CssClass="dis" AutoPostBack="true" Width="160px" OnSelectedIndexChanged="dgvnumcred_SelectedIndexChanged"></asp:DropDownList><%--<input id="txtcodigo" onkeypress="return numeros(event);"  runat="server" class="form-control" type="text" name="codigo" placeholder="Codigo Mensajero" required="required" tabindex="1" autofocus="autofocus"  />   --%>     
          <span id="span1" runat="server" style="font-size:15px">Area </span>  <asp:DropDownList ID="asignado" runat="server" CssClass="dis" AutoPostBack="true" Width="160px" OnSelectedIndexChanged="asignado_SelectedIndexChanged"></asp:DropDownList>
           </div>
               </div>
             </div>
