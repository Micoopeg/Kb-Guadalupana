    ...
    public class ModeloEX
    {
        ...
        public string[] cartaenvio(string area)
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                try
                {
                    string consultaGraAsis = "SELECT gaso.gen_fecha_creacion,gaso.cifgeneral, gcrd.gen_numcredito, CONCAT_ws(' ',gaso.primer_nombre, gaso.segundo_nombre, gaso.primer_apellido, gaso.segundo_apellido) AS nombrecompleto , CONCAT('Q',FORMAT(gcrd.gen_monto,2,'de_DE')) as gen_monto, extp.ex_nomtipo FROM gen_credito gcrd INNER JOIN gen_asociado gaso ON gaso.codgenasociado = gcrd.codgenasociado INNER JOIN ex_tipocredito extp ON extp.codextipocred = gaso.codgarantia INNER JOIN ex_temporal1 tmp ON tmp.Nocredito = gcrd.gen_numcredito WHERE tmp.codexarea = '" + area+"' AND  tmp.estado = 7";
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand(consultaGraAsis, sqlCon);
                    MySqlDataReader reader = command.ExecuteReader();
                    while (reader.Read())
        ...
        public DataTable llenarGridViewevento()
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand("SELECT exp.codexp, gaso.gen_fecha_creacion,gaso.cifgeneral, gcrd.gen_numcredito, CONCAT(gaso.primer_nombre, ' ' , gaso.segundo_nombre, ' ' , gaso.primer_apellido, ' ' , gaso.segundo_apellido) AS nombrecompleto , CONCAT('Q',FORMAT(gcrd.gen_monto,2,'de_DE')) as gen_monto, extp.ex_nomtipo FROM ex_envio exenv INNER JOIN ex_bitacora exb ON exenv.codexenvio = exb.codexenvio INNER JOIN ex_expediente exp ON exp.codexp=exb.codexp INNER JOIN gen_credito gcrd ON gcrd.codgencred = exp.codgencred INNER JOIN gen_asociado gaso ON gaso.codgenasociado = gcrd.codgenasociado INNER JOIN ex_tipocredito extp ON extp.codextipocred = gaso.codgarantia INNER JOIN ex_temporal1 extmp ON extmp.codexp = exp.codexp WHERE extmp.estado = 7", sqlCon);
        ...
        public DataTable llenardgvnegocios(string crd)
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand(" SELECT gaso.cifgeneral, gcrd.gen_numcredito, CONCAT_ws(' ',gaso.primer_nombre, gaso.segundo_nombre, gaso.primer_apellido, gaso.segundo_apellido) AS nombrecompleto , CONCAT('Q',FORMAT(gcrd.gen_monto,2,'de_DE')) as gen_monto, extp.ex_nomtipo FROM gen_credito gcrd INNER JOIN gen_asociado gaso ON gaso.codgenasociado = gcrd.codgenasociado INNER JOIN ex_tipocredito extp ON extp.codextipocred = gaso.codgarantia INNER JOIN ex_temporal1 tmp ON tmp.Nocredito = gcrd.gen_numcredito INNER JOIN ex_expediente exp ON exp.codgencred = gcrd.gen_numcredito INNER JOIN ex_envio exenv ON exenv.Nocredito=exp.codgencred WHERE exp.codgencred ='" + crd+"' ", sqlCon);
                    MySqlDataAdapter ds = new MySqlDataAdapter();
                    ds.SelectCommand = command;
                    ds.Fill(dt);
        ...
        public DataTable llenarGridViewevento3(string user)
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand("SELECT DISTINCT gaso.gen_fecha_creacion, gaso.cifgeneral, gcrd.gen_numcredito, CONCAT_ws(' ',gaso.primer_nombre, gaso.segundo_nombre, gaso.primer_apellido, gaso.segundo_apellido) AS nombrecompleto , CONCAT('Q',FORMAT(gaso.gen_premonto,2,'de_DE')) as gen_monto, extp.ex_nomtipo FROM gen_credito gcrd INNER JOIN gen_asociado gaso ON gaso.codgenasociado = gcrd.codgenasociado INNER JOIN ex_tipocredito extp ON extp.codextipocred = gaso.codgarantia WHERE NOT EXISTS ( SELECT null FROM ex_expediente exp WHERE gcrd.gen_numcredito = exp.codgencred) AND gaso.usercreacion = '" + user + "' AND NOT EXISTS ( SELECT null FROM ex_temporal1 tmp WHERE tmp.Nocredito = gcrd.gen_numcredito ) AND gaso.gen_fecha_creacion > '2020-12-30' ;", sqlCon);
                    MySqlDataAdapter ds = new MySqlDataAdapter();
                    ds.SelectCommand = command;
                    ds.Fill(dt);
        ...
        public DataTable llenarGridViewevento2(string user)
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand("SELECT gaso.gen_fecha_creacion,gaso.cifgeneral, gcrd.gen_numcredito, CONCAT_ws(' ',gaso.primer_nombre, gaso.segundo_nombre, gaso.primer_apellido, gaso.segundo_apellido) AS nombrecompleto , CONCAT('Q',FORMAT(gcrd.gen_monto,2,'de_DE')) as gen_monto, extp.ex_nomtipo FROM gen_credito gcrd INNER JOIN gen_asociado gaso ON gaso.codgenasociado = gcrd.codgenasociado INNER JOIN ex_tipocredito extp ON extp.codextipocred = gaso.codgarantia INNER JOIN ex_temporal1 tmp ON tmp.Nocredito = gcrd.gen_numcredito WHERE gaso.usercreacion = '" + user+ "' AND tmp.estado = 7  ", sqlCon);
                    MySqlDataAdapter ds = new MySqlDataAdapter();
                    ds.SelectCommand = command;
                    ds.Fill(dt);
        ...
        public DataTable llenarexphall(string area)
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand("SELECT DISTINCT gaso.gen_fecha_creacion,gaso.cifgeneral, gcrd.gen_numcredito, CONCAT_ws(' ',gaso.primer_nombre, gaso.segundo_nombre, gaso.primer_apellido, gaso.segundo_apellido) AS nombrecompleto , CONCAT('Q',FORMAT(gcrd.gen_monto,2,'de_DE')) as gen_monto, extp.ex_nomtipo FROM gen_credito gcrd INNER JOIN gen_asociado gaso ON gaso.codgenasociado = gcrd.codgenasociado INNER JOIN ex_tipocredito extp ON extp.codextipocred = gaso.codgarantia INNER JOIN ex_temporal1 tmp ON tmp.Nocredito = gcrd.gen_numcredito INNER JOIN ex_expediente exp ON exp.codgencred = gcrd.gen_numcredito INNER JOIN ex_hallazgos exh ON exh.codexp = exp.codexp WHERE tmp.codexarea = '" + area + "'", sqlCon);
                    MySqlDataAdapter ds = new MySqlDataAdapter();
                    ds.SelectCommand = command;
                    ds.Fill(dt);
        ...
        public DataTable llenarenviomesaarch()
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand("SELECT gaso.gen_fecha_creacion,gaso.cifgeneral, gcrd.gen_numcredito, CONCAT_ws(' ',gaso.primer_nombre, gaso.segundo_nombre, gaso.primer_apellido, gaso.segundo_apellido) AS nombrecompleto , gcrd.gen_monto, extp.ex_nomtipo FROM gen_credito gcrd INNER JOIN gen_asociado gaso ON gaso.codgenasociado = gcrd.codgenasociado INNER JOIN ex_tipocredito extp ON extp.codextipocred = gaso.codgarantia INNER JOIN ex_temporal1 tmp ON tmp.Nocredito = gcrd.gen_numcredito INNER JOIN ex_envio exev  ON exev.Nocredito = tmp.Nocredito  WHERE  exev.estado = 8 AND exev.codexetapa = 5 ", sqlCon);
                    MySqlDataAdapter ds = new MySqlDataAdapter();
                    ds.SelectCommand = command;
                    ds.Fill(dt);
        ...
        public DataTable llenarmesa()
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand("SELECT gaso.gen_fecha_creacion,gaso.cifgeneral, gcrd.gen_numcredito, CONCAT_ws(' ',gaso.primer_nombre, gaso.segundo_nombre, gaso.primer_apellido, gaso.segundo_apellido) AS nombrecompleto , CONCAT('Q',FORMAT(gcrd.gen_monto,2,'de_DE')) as gen_monto, extp.ex_nomtipo FROM gen_credito gcrd INNER JOIN gen_asociado gaso ON gaso.codgenasociado = gcrd.codgenasociado INNER JOIN ex_tipocredito extp ON extp.codextipocred = gaso.codgarantia INNER JOIN ex_temporal1 tmp ON tmp.Nocredito = gcrd.gen_numcredito INNER JOIN ex_expediente exp ON exp.codgencred = gcrd.gen_numcredito INNER JOIN ex_envio exenv ON exenv.Nocredito=exp.codgencred  WHERE tmp.estado = 2 AND exenv.codexetapa = 3 AND exenv.estado = 1 AND NOT EXISTS ( SELECT null FROM ex_asignado exas WHERE exas.codexp = exp.codexp)   ", sqlCon);
                    MySqlDataAdapter ds = new MySqlDataAdapter();
                    ds.SelectCommand = command;
                    ds.Fill(dt);
        ...
        public DataTable llenarmesarchasignado(string coduser)
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand("SELECT  DISTINCT  gaso.gen_fecha_creacion,gaso.cifgeneral, gcrd.gen_numcredito, CONCAT_ws(' ',gaso.primer_nombre, gaso.segundo_nombre, gaso.primer_apellido, gaso.segundo_apellido) AS nombrecompleto , CONCAT('Q',FORMAT(gcrd.gen_monto,2,'de_DE')) as gen_monto, extp.ex_nomtipo FROM gen_credito gcrd INNER JOIN gen_asociado gaso ON gaso.codgenasociado = gcrd.codgenasociado INNER JOIN ex_tipocredito extp ON extp.codextipocred = gaso.codgarantia INNER JOIN ex_temporal1 tmp ON tmp.Nocredito = gcrd.gen_numcredito INNER JOIN ex_expediente exp ON exp.codgencred = gcrd.gen_numcredito INNER JOIN ex_envio exenv ON exenv.Nocredito=exp.codgencred INNER JOIN ex_asignado exasig ON exasig.codexp = exp.codexp WHERE   exenv.codexetapa = 5 AND exenv.estado = 1 AND exasig.codasignado = '" + coduser + "' AND (exasig.proceso = 3 OR exasig.proceso = 4)", sqlCon);
                    MySqlDataAdapter ds = new MySqlDataAdapter();
                    ds.SelectCommand = command;
                    ds.Fill(dt);
        ...
        public DataTable codigostable(string user)
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand("SELECT tmp.Nocredito, CONCAT(gaso.primer_nombre, ' ' , gaso.segundo_nombre, ' ' , gaso.primer_apellido, ' ', gaso.segundo_apellido) as nomcom, gaso.cifgeneral, CONCAT('Q',FORMAT(gcrd.gen_monto,2,'de_DE')) as gen_monto, gcrd.gen_fechadesembolso  FROM gen_credito gcrd INNER JOIN gen_asociado gaso ON gaso.codgenasociado = gcrd.codgenasociado INNER JOIN ex_tipocredito extp ON extp.codextipocred = gaso.codgarantia INNER JOIN ex_temporal1 tmp ON tmp.Nocredito = gcrd.gen_numcredito WHERE gaso.usercreacion = '" + user+"' AND tmp.estado = 7", sqlCon);
                    MySqlDataAdapter ds = new MySqlDataAdapter();
                    ds.SelectCommand = command;
                    ds.Fill(dt);
