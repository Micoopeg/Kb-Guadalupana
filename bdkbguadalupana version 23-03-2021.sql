...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-03-2021 a las 21:39:42
...
--
-- Estructura de tabla para la tabla `ex_asociado`
--

DROP TABLE IF EXISTS `ex_asociado`;
CREATE TABLE `ex_asociado` (
  `codexasociado` int(11) NOT NULL,
  `ex_asesor` int(11) NOT NULL,
  `ex_cif` int(11) NOT NULL,
  `ex_pnombre` varchar(40) NOT NULL,
  `ex_snombre` varchar(40) NOT NULL,
  `ex_papell` varchar(40) NOT NULL,
  `ex_sapell` varchar(40) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `ex_bitacora`
--

DROP TABLE IF EXISTS `ex_bitacora`;
CREATE TABLE `ex_bitacora` (
  `codexp` int(11) NOT NULL,
  `ex_fechaev` varchar(20) NOT NULL,
  `codusuario` int(11) NOT NULL,
  `codexevento` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `ex_controlarea`
--

DROP TABLE IF EXISTS `ex_controlarea`;
CREATE TABLE `ex_controlarea` (
  `codexcontrolarea` int(11) NOT NULL,
  `ex_nombrea` varchar(50) NOT NULL,
  `extipoarea` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `ex_controlingreso`
--

DROP TABLE IF EXISTS `ex_controlingreso`;
CREATE TABLE `ex_controlingreso` (
  `codexcontroling` int(11) NOT NULL,
  `ex_controlusuario` varchar(20) NOT NULL,
  `ex_controlarea` int(11) NOT NULL,
  `ex_controlrol` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `ex_creditos`
--

DROP TABLE IF EXISTS `ex_creditos`;
CREATE TABLE `ex_creditos` (
  `codexcrd` int(11) NOT NULL,
  `codexasociado` int(11) NOT NULL,
  `ex_monto` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `ex_expediente`
--

DROP TABLE IF EXISTS `ex_expediente`;
CREATE TABLE `ex_expediente` (
  `codexp` int(11) NOT NULL,
  `codexcrd` int(11) NOT NULL,
  `codusuario` int(11) NOT NULL,
  `ex_ean13` int(13) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `ex_roles`
--

DROP TABLE IF EXISTS `ex_roles`;
CREATE TABLE `ex_roles` (
  `codexrol` int(11) NOT NULL,
  `ex_nomrol` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `ex_tipoarea`
--

DROP TABLE IF EXISTS `ex_tipoarea`;
CREATE TABLE `ex_tipoarea` (
  `codtipoarea` int(11) NOT NULL,
  `ex_nomtipoarea` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `ex_tipoevento`
--

DROP TABLE IF EXISTS `ex_tipoevento`;
CREATE TABLE `ex_tipoevento` (
  `codexevento` int(11) NOT NULL,
  `ex_evento` varchar(40) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `ex_tipoevento`
--

INSERT INTO `ex_tipoevento` (`codexevento`, `ex_evento`) VALUES
(1, 'RECEPCION'),
(2, 'ENVIO'),
(3, 'AUDITORIA'),
(4, 'REVISADO'),
...
(3, 'ARQ', 'Arqueos', '../MantenimientosControl/SeguridadArqueo.aspx', 1),
...
--
-- Estructura de tabla para la tabla `gen_areaapp`
--

DROP TABLE IF EXISTS `gen_areaapp`;
CREATE TABLE `gen_areaapp` (
  `codeareaapp` int(11) NOT NULL,
  `codgenarea` int(11) NOT NULL,
  `codegenapp` int(11) NOT NULL,
  `gen_urlareaapp` varchar(70) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `gen_areaapp`
--

INSERT INTO `gen_areaapp` (`codeareaapp`, `codgenarea`, `codegenapp`, `gen_urlareaapp`) VALUES
(1, 30, 1, ''),
(2, 39, 2, '../Agenda/AgendaPrin.aspx'),
(3, 39, 4, ''),
(4, 39, 5, ''),
(5, 22, 3, ''),
(6, 22, 6, '');
...
--
-- Indices de la tabla `ex_bitacora`
--
ALTER TABLE `ex_bitacora`
  ADD PRIMARY KEY (`codexp`),
  ADD KEY `codexp` (`codexp`),
  ADD KEY `codusuario` (`codusuario`);

--
-- Indices de la tabla `ex_controlarea`
--
ALTER TABLE `ex_controlarea`
  ADD PRIMARY KEY (`codexcontrolarea`),
  ADD KEY `extipoarea` (`extipoarea`);

--
-- Indices de la tabla `ex_controlingreso`
--
ALTER TABLE `ex_controlingreso`
  ADD PRIMARY KEY (`codexcontroling`),
  ADD KEY `ex_controlarea` (`ex_controlarea`),
  ADD KEY `ex_controlrol` (`ex_controlrol`);

--
-- Indices de la tabla `ex_creditos`
--
ALTER TABLE `ex_creditos`
  ADD PRIMARY KEY (`codexcrd`);

--
-- Indices de la tabla `ex_expediente`
--
ALTER TABLE `ex_expediente`
  ADD PRIMARY KEY (`codexp`);

--
-- Indices de la tabla `ex_roles`
--
ALTER TABLE `ex_roles`
  ADD PRIMARY KEY (`codexrol`);

--
-- Indices de la tabla `ex_tipoarea`
--
ALTER TABLE `ex_tipoarea`
  ADD PRIMARY KEY (`codtipoarea`);

--
-- Indices de la tabla `ex_tipoevento`
--
ALTER TABLE `ex_tipoevento`
  ADD PRIMARY KEY (`codexevento`);
...
--
-- Indices de la tabla `gen_areaapp`
--
ALTER TABLE `gen_areaapp`
  ADD PRIMARY KEY (`codeareaapp`),
  ADD KEY `codegenapp` (`codegenapp`),
  ADD KEY `codgenarea` (`codgenarea`);
...
--
-- AUTO_INCREMENT de la tabla `ex_controlingreso`
--
ALTER TABLE `ex_controlingreso`
  MODIFY `codexcontroling` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `ex_creditos`
--
ALTER TABLE `ex_creditos`
  MODIFY `codexcrd` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `ex_tipoevento`
--
ALTER TABLE `ex_tipoevento`
  MODIFY `codexevento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `gen_areaapp`
--
ALTER TABLE `gen_areaapp`
  MODIFY `codeareaapp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `gen_mdimenu`
  MODIFY `codgenmdi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
-- Filtros para la tabla `ex_bitacora`
--
ALTER TABLE `ex_bitacora`
  ADD CONSTRAINT `ex_bitacora_ibfk_1` FOREIGN KEY (`codexp`) REFERENCES `ex_expediente` (`codexp`),
  ADD CONSTRAINT `ex_bitacora_ibfk_2` FOREIGN KEY (`codusuario`) REFERENCES `ex_controlingreso` (`codexcontroling`);

--
-- Filtros para la tabla `ex_controlarea`
--
ALTER TABLE `ex_controlarea`
  ADD CONSTRAINT `ex_controlarea_ibfk_1` FOREIGN KEY (`extipoarea`) REFERENCES `ex_tipoarea` (`codtipoarea`);

--
-- Filtros para la tabla `ex_controlingreso`
--
ALTER TABLE `ex_controlingreso`
  ADD CONSTRAINT `ex_controlingreso_ibfk_1` FOREIGN KEY (`ex_controlarea`) REFERENCES `ex_controlarea` (`codexcontrolarea`),
  ADD CONSTRAINT `ex_controlingreso_ibfk_2` FOREIGN KEY (`ex_controlrol`) REFERENCES `ex_roles` (`codexrol`);
...
--
-- Filtros para la tabla `gen_areaapp`
--
ALTER TABLE `gen_areaapp`
  ADD CONSTRAINT `gen_areaapp_ibfk_1` FOREIGN KEY (`codegenapp`) REFERENCES `gen_aplicacion` (`codgenapp`),
  ADD CONSTRAINT `gen_areaapp_ibfk_2` FOREIGN KEY (`codgenarea`) REFERENCES `gen_area` (`codgenarea`);
