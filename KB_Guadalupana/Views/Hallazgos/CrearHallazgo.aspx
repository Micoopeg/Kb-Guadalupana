<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CrearHallazgo.aspx.cs" Inherits="KB_Guadalupana.Views.Hallazgos.CrearHallazgo" %>
  ...
  <div class="inset">
      ...
      <%--  <p class="col-md-3">
       ...
       <asp:DropDownList id="IGADepa1" runat="server" class="dis" AutoPostBack="true" ></asp:DropDownList>
        ...
        <p class="col-md-3">
            <label style="color:white">Mes del Hallazgo</label>
                <select id="MesH" runat="server" class="dis">
          ...
          <p class="col-md-3">
            <label style="color:white">Año del Hallazgo</label>
                <select id="Año" runat="server" class="dis">
        ...
        <p class="col-md-6">
            ...
            <br>
            <asp:FileUpload id="archivo" runat="server" style="color: white;" />
        ...
        <p class="col-md-6">
          ...
          <%-- <p class="col-md-6">
            ...
            <textarea id="Comentario" runat="server" name="texto" rows="3" cols="42"></textarea>
        </p>--%>
         
          
          <p class="col-md-6">
             <input type="button" style="margin-left: 100px;margin-top: 60px;" class="button" Value="Asignar" runat="server" name="next" onclick="Guardar()"/>
        </p>
</div>
  </div>
