<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="porsuc.aspx.cs" Inherits="KB_Guadalupana.Views.test.reporte.porsuc" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="container main">
        <h2>Filtre por Sucursal.</h2>
        <div class="form-group">
            <label for="inputdefault">Seleccione Sucursal</label>
