                ...
                <div class="encabezado">
                   ...
                   <div class="formatoTitulo" style="margin-bottom:5px">
                        ...
                        <div class="formatoTitulo" style="margin-bottom:5px">
                            ...
                            <label class="titulos" style="margin-left:19%"><b>Centro de costo</b></label>
                        </div>
                        <div class="formato">
                            ...
                            <input id="CentroCosto" runat="server" type="text" class="formatoinput3" placeholder="Ingrese concepto" maxlength="600" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" />
                        </div>
