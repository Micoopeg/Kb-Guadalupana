<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditarGerencia.aspx.cs" Inherits="KB_Guadalupana.Views.Hallazgos.EditarGerencia" %>
...
<div class="row" style="margin-right: 0px;" >
    <div class="inset">
        <div class="row">
            <p class="col-md-3">
                <label style="color:white">ID Gerencia</label>
                <input style="height: 36px;" type="text"  id="ID" runat="server" disabled/>
            </p>
            <p class="col-md-4">
                <label style="color:white">Nombre Gerencia</label>
    ...
    AutoGenerateColumns="False" BorderStyle="Solid"  OnSelectedIndexChanged = "OnSelectedIndexChangedReporte">
                     <Columns>
                          <asp:TemplateField ControlStyle-CssClass="diseño"  HeaderText="ID Gerencia">
                        <ItemTemplate>
                           <asp:Label ID="idhallazgo" Text='<%# Eval("sh_gerencias_id_shgerencia") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                        <asp:TemplateField ControlStyle-CssClass="diseño"  HeaderText="ID Area">
                        <ItemTemplate>
                           <asp:Label ID="lblrubro" Text='<%# Eval("id_sharea") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                        <asp:TemplateField ControlStyle-CssClass="diseño"  HeaderText="Nombre Area">
                           <ItemTemplate>
                           <asp:Label ID="Estado1" Text='<%# Eval("sh_areanombre") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
