	...
	<nav class="nav">
     ...
     <div class="container justify-content-center aling-items-center minh-100" style="max-width: 850px;">
            ...
            <div class="form-group" style="text-align: center">
                ...
                <input id="AVTITULO" type="text" runat="server" disabled="disabled" class="form-control form-control-lg"  aria-describedby="emailHelp" placeholder="Numero del expediente" style="text-align: center;"/>
            </div>
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input id="PNOMBRE" type="text" runat="server" class="form-control form-control-lg" placeholder="Primer Nombre" />
                        <input id="PAPELL" type="text" runat="server" class="form-control form-control-lg" placeholder="Primer Apellido" />
                      <h5 style="text-align:end; margin-top:15px;" >CIF</h5>
                    </div>
                     <div class="col">
                          <input id="SNOMBRE" type="text" runat="server" class="form-control form-control-lg" placeholder="Segundo Nombre" />
                
                        <input id="SAPELL" type="text" runat="server" class="form-control form-control-lg" placeholder="Segundo Apellido" />
                          <input id="Number1" runat="server" class="form-control form-control-lg"  maxlength="6" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="number" min="0" />
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col">
                         ...
                         <asp:DropDownList  id="DropDownTipocredito" runat="server"   class="form-control" AutoPostBack="false"  ></asp:DropDownList>
                         <h5>Monto</h5>
                        <span class="input-group-text" id="basic-addon1">GTQ</span>
                        <input id="MONTO" runat="server" class="form-control form-control-lg"  maxlength="15" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="number" min="0" />
                    </div>
                    <div class="col">
                        <h5>Enviar a</h5>
                         <asp:DropDownList  id="DropDownenvio" runat="server"   class="form-control" AutoPostBack="false"  ></asp:DropDownList>
            ...
            <div class="form-group" style="text-align: center">
                ...
                <textarea id="AVDESCRIP" runat="server" class="form-control form-control-lg"  rows="4" maxlength="250"></textarea>
            </div>
            <center>
            <div class="container">
