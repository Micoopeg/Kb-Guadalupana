    ...
    public partial class RequerimientoPagoDesistimiento : System.Web.UI.Page
    {
        ...
        public void llenarcombodocumento()
        {
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    string query = "SELECT * FROM pj_tipodocumento  WHERE idpj_tipodocumento = 59";
                    MySqlDataAdapter myCommand = new MySqlDataAdapter(query, sqlCon);
                    DataSet ds = new DataSet();
                    myCommand.Fill(ds);
        ...
        protected void Rechazar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                sn.estadodevuelto(numcredito, "34", "33");
                ...
                sn.insertarbitacora(sig3, NumeroIncidente.Value, numcredito, NombreCliente.Value, "Devuelto", "34", "51", fechahoraactual, fechacreacion2, ObservacionesCredito.Value);
