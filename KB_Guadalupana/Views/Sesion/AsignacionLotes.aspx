<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AsignacionLotes.aspx.cs" Inherits="KB_Guadalupana.Views.Sesion.AsignacionLotes" %>
...
<body>
    ...
    <a class="button button5" style="right: 8%;position: absolute;margin-top: -500px;" target="_blank" href="Ayudas/AyudaALote.aspx" ><i class="fa fa-question"></i></a>
     ...
     <div class="menu"></div>
        <div class="mantenimientos">
          ...
          <a href="AsignacionLotes.aspx" onclick="MantenimientoMoneda()" id="MantenimientoMoneda">Asignar Lotes</a>
        </div>
 ...
 <div >
     <div class="encabezado">
         <h2 class="fs-title">
            <b>Cotrol de Estado Patrimonial</b>
        </h2>
  ...
  <div class="buscar">
    ...
    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Ver todos" CssClass="tam" />
     ...
     <br />
      <asp:GridView ID="GridView1" CssClass="tabla" runat="server" AutoGenerateColumns="false" DataKeyNames="codepadministracionlote"
  ...
  <div class="tablas">
     <asp:GridView ID="GridView2" CssClass="tabla2" DataKeyNames="codepcontrol" AutoGenerateColumns="true" runat="server" 
         ShowHeaderWhenEmpty="true"
         OnRowUpdating="GridView2_RowUpdating" OnRowCancelingEdit="GridView2_RowCancelingEdit" 
         OnRowEditing="GridView2_RowEditing" OnRowCommand="GridView2_RowCommand" OnRowDeleting="GridView2_RowDeleting">
       <%--  <Columns>
                    <asp:TemplateField HeaderText="Código">
                        <ItemTemplate>
                            <asp:Label  Text='<%# Eval("codepcontrol") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                  ...
                  <ItemTemplate>
                         ...
                         <EditItemTemplate>
                            <asp:TextBox ID="txtFirstName" Text='<%# Eval("codepadministracionlote") %>' runat="server" />
                        </EditItemTemplate>
                    </asp:TemplateField>
      ...
      <asp:GridView ID="GridView3" CssClass="tabla" DataKeyNames="codgenusuario" AutoGenerateColumns="false" runat="server" 
         ShowHeaderWhenEmpty="true"
         OnRowUpdating="GridView3_RowUpdating" OnRowCancelingEdit="GridView3_RowCancelingEdit" 
         OnRowEditing="GridView3_RowEditing" OnRowCommand="GridView3_RowCommand" OnRowDeleting="GridView3_RowDeleting">
         <Columns>
              <asp:TemplateField HeaderText="No. de usuario">
                  <ItemTemplate>
                            <asp:Label Text='<%# Eval("codgenusuario") %>' runat="server" />
                        </ItemTemplate>
                  <EditItemTemplate>
                            <asp:TextBox ID="txtContact" Text='<%# Eval("codgenusuario") %>' runat="server" />
                        </EditItemTemplate>
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="No. de Lote">
                  <ItemTemplate>
                            <asp:Label Text='<%# Eval("codepadministracionlote") %>' runat="server" />
                        </ItemTemplate>
                         <EditItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Opciones">
                        <ItemTemplate>
                            <asp:ImageButton ImageUrl="../../Imagenes/edit.png" CssClass="imagen" runat="server" CommandName="Edit" ToolTip="Edit" Width="20px" Height="20px"/>
                           
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:ImageButton ImageUrl="../../Imagenes/save.png" CssClass="imagen" runat="server" CommandName="Update" ToolTip="Update" Width="20px" Height="20px"/>
                            <asp:ImageButton ImageUrl="../../Imagenes/cancel.png" CssClass="imagen" runat="server" CommandName="Cancel" ToolTip="Cancel" Width="20px" Height="20px"/>
                        </EditItemTemplate>
                    </asp:TemplateField>
                </Columns>
     </asp:GridView>
