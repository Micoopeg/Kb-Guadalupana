    ...
    <form id="form1" runat="server">
         <div class="general">
            <div class="formularioCobros">
                ...
                <div style="overflow: auto; height: 400px">
                        <asp:GridView ID="gridViewNotificacion" runat="server" CssClass="tabla" AutoGenerateColumns="False" ForeColor="Black"
                            OnSelectedIndexChanged = "OnSelectedIndexChangedNotificacion" BorderStyle="Solid">
                            <Columns>
                                <asp:TemplateField ControlStyle-CssClass="diseño" visible="false" HeaderText="No. de crédito">
                                    <ItemTemplate>
                                       <asp:Label ID="lbletapa" Text='<%# Eval("etapa") %>' runat="server" />
