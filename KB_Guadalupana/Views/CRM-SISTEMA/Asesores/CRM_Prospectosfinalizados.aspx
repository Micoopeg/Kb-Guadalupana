<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRM_Prospectosfinalizados.aspx.cs" Inherits="CRM_Guadalupana.Views.CRM_SISTEMA.Asesores.CRM_Prospectosfinalizados" %>
  ...
  <div class="row">
    ...
    <div class="col-sm-4">
        <center>
         ...
         <div class="col-sm-4">
             <asp:LinkButton ID="LinkButton3" class="btn btn-success" style="background-color:#003561; text-decoration:none; border-color:#003561; border-radius:0px; width:100%" value="Cerrar sesion" type="button" runat="server" tabindex="25" name="Guardar" title="Cerrar sesion" OnClick="LinkButton3_Click"  >Cerrar Sesion</asp:LinkButton>
    </div>
  </div>
        </header>
