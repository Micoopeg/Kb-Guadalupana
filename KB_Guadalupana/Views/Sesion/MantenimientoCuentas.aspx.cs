...
{
    public partial class MantenimientoCuentas : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            RCCodigo.Value = logic.siguiente("ep_tipocuenta", "codeptipocuenta");
            RCCodigo.Disabled = false;
        }
        ...
        protected void gvPhoneBook_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName.Equals("AddNew"))
                {
                    ...
                    {
                        sqlCon.Open();
                        string query = "INSERT INTO ep_tipocuenta (codeptipocuenta,ep_tipocuentanombre) VALUES (@FirstName,@Contact)";
        ...
        protected void gvPhoneBook_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                ...
                {
                    sqlCon.Open();
                    string query = "UPDATE ep_tipocuenta SET codeptipocuenta=@FirstName,ep_tipocuentanombre=@Contact WHERE codeptipocuenta = @id";
                    MySqlCommand sqlCmd = new MySqlCommand(query, sqlCon);
        ...
        protected void gvPhoneBook_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                {
                    sqlCon.Open();
                    string query = "DELETE FROM ep_tipocuenta WHERE codeptipocuenta = @id";
                    MySqlCommand sqlCmd = new MySqlCommand(query, sqlCon);
                    sqlCmd.Parameters.AddWithValue("@id", Convert.ToInt32(gvPhoneBook.DataKeys[e.RowIndex].Value.ToString()));
                    sqlCmd.ExecuteNonQuery();
                    PopulateGridview();
        ...
        {
            MySqlDataAdapter ad = new MySqlDataAdapter("SELECT * FROM ep_tipocuenta;", conn.conectar());
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                string QueryString = "SELECT * FROM ep_tipocuenta WHERE ep_tipocuentanombre='" + TextBox1.Text + "';";
                MySqlDataAdapter myCommand = new MySqlDataAdapter(QueryString, conn.conectar());
                DataTable ds3 = new DataTable();
                myCommand.Fill(ds3);
                gvPhoneBook.DataSource = ds3;
