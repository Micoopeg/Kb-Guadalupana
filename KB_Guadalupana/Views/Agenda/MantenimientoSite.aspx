<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MantenimientoSite.aspx.cs" Inherits="KB_Guadalupana.Views.Agenda.MantenimientoSite" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
 <link rel="stylesheet" href="../../AvDiseños/AvMantenimientoSite.css">
...
<div class='under'>
  <header class='under__content'>
    <h1 class='under__title'>Sitio en Mantenimiento</h1>
    <div class='under__text'>Estamos realizando cambios en el sitio. Contacta al área de informática, resolveremos tus dudas.</div>
  </header>
...
<g id="large">
	...
	<path d="M55.777,38.473l6.221-1.133c0.017-1.791-0.123-3.573-0.41-5.324l-6.321-0.19c-0.438-2.053-1.135-4.048-2.076-5.931
		...
		c-6.244-2.999-8.872-10.493-5.867-16.736c3.002-6.244,10.495-8.873,16.736-5.869C42.676,28.698,45.306,36.19,42.302,42.435z"  fill="none" stroke="#8edba6"/>    <animateTransform 
...
<g id="small">
	<path d="M93.068,19.253L99,16.31c-0.371-1.651-0.934-3.257-1.679-4.776l-6.472,1.404c-0.902-1.436-2.051-2.735-3.42-3.819
		...
		C84.573,16.331,86.05,20.549,84.365,24.062z" fill="none" stroke="#8edba6"/>  
  <animateTransform 
            attributeName="transform"
            begin="0s"
            dur="2s"
		...
		<h2>Volveremos a la brevedad 👌</h2>
  <div class='wave'></div>
