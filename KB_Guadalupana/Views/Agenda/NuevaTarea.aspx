 <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NuevaTarea.aspx.cs" Inherits="KBGuada.Views.session.NuevaTarea" %>
     ...
     <div class="topnav">
        ...
        <div class="container justify-content-center aling-items-center minh-100" style="max-width: 500px;">
              ...
              <div class="form-group" style="text-align: center">
                  <label>
               <h1 style="border-top: double; border-bottom: double;font-size: 37px; font-family: Montserrat;  padding-bottom: 10px; " >Nueva Tarea</h1>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col">
                         <h5>Telefono</h5>
                        <input id="AVTEL" runat="server" class="form-control form-control-lg"  maxlength="8" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="number" min="0" />
                         <h5>Monto</h5>
                        <span class="input-group-text" id="basic-addon1">GTQ</span>
                        <input id="MONTO" runat="server" class="form-control form-control-lg"  maxlength="20" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="number" min="0" />
                    </div>
                    <div class="col">
            ...
            <div class="container">
              ...
              <asp:Button ID="btninsert" runat="server" Cssclass="custom-btn btn-8" OnClick="btnInsertar_Click" Text="Agregar Tarea" />
        ...
        <asp:LinkButton ID="btninsertar" runat="server" OnClick="btnInsertar_Click" ClientIDMode="Static"></asp:LinkButton>
