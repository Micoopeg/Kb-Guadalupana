    ...
    public class ModeloSQ
    {
        ...
        public DataTable JEFE15(string iduser)
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand(" SELECT b.ordenpregunta AS ORDEN , a.codsquser as EVALUADOR, a.usuario_calificado AS EVALUADO , b.pregunta, c.nota FROM sq_resultadopregunta a INNER JOIN sq_preguntas b ON a.codsqpregunta= b.codsqpregunta INNER JOIN sq_calificaciones c ON c.codsqcalificacion = a.resultado WHERE a.usuario_calificado = '" + iduser + "' AND a.codsquser = ((SELECT m.codsqpersonal FROM sq_personal m WHERE m.codesqpuesto = ((SELECT f.codsqpuesto FROM sq_organigrama f INNER JOIN sq_personal t ON t.codesqpuesto = f.organisup WHERE t.codsqpersonal = '" + iduser + "')))) HAVING ORDEN >0 AND ORDEN<6 ORDER BY a.codsqrespreg, b.ordenpregunta", sqlCon);
                    MySqlDataAdapter ds = new MySqlDataAdapter();
                    ds.SelectCommand = command;
                    ds.Fill(dt);
        ...
        public DataTable JEFE613(string iduser)
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand(" SELECT b.ordenpregunta AS ORDEN , a.codsquser as EVALUADOR, a.usuario_calificado AS EVALUADO , b.pregunta, c.nota FROM sq_resultadopregunta a INNER JOIN sq_preguntas b ON a.codsqpregunta= b.codsqpregunta INNER JOIN sq_calificaciones c ON c.codsqcalificacion = a.resultado  WHERE  a.usuario_calificado = '" + iduser + "' AND a.codsquser = ((SELECT m.codsqpersonal FROM sq_personal m WHERE m.codesqpuesto = ((SELECT f.codsqpuesto FROM sq_organigrama f INNER JOIN sq_personal t ON t.codesqpuesto = f.organisup WHERE t.codsqpersonal = '" + iduser + "'))))  HAVING ORDEN >5 AND ORDEN<21 ORDER BY a.codsqrespreg, b.ordenpregunta", sqlCon);
                    MySqlDataAdapter ds = new MySqlDataAdapter();
                    ds.SelectCommand = command;
                    ds.Fill(dt);
        ...
        public DataTable JEFE6132(string iduser)
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand(" SELECT b.ordenpregunta AS ORDEN , a.codsquser as EVALUADOR, a.usuario_calificado AS EVALUADO , b.pregunta, c.nota FROM sq_resultadopregunta a INNER JOIN sq_preguntas b ON a.codsqpregunta= b.codsqpregunta INNER JOIN sq_calificaciones c ON c.codsqcalificacion = a.resultado  WHERE  a.usuario_calificado = '" + iduser + "' AND a.codsquser = ((SELECT m.codsqpersonal FROM sq_personal m WHERE m.codesqpuesto = ((SELECT f.codsqpuesto FROM sq_organigrama f INNER JOIN sq_personal t ON t.codesqpuesto = f.organisup WHERE t.codsqpersonal = '" + iduser + "'))))  HAVING ORDEN >5 AND ORDEN<14 ORDER BY a.codsqrespreg, b.ordenpregunta", sqlCon);
                    MySqlDataAdapter ds = new MySqlDataAdapter();
                    ds.SelectCommand = command;
                    ds.Fill(dt);
        ...
        public DataTable JEFE1420(string iduser)
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand(" SELECT b.ordenpregunta AS ORDEN , a.codsquser as EVALUADOR, a.usuario_calificado AS EVALUADO , b.pregunta, c.nota FROM sq_resultadopregunta a INNER JOIN sq_preguntas b ON a.codsqpregunta= b.codsqpregunta INNER JOIN sq_calificaciones c ON c.codsqcalificacion = a.resultado WHERE a.usuario_calificado = '" + iduser + "' AND a.codsquser = ((SELECT m.codsqpersonal FROM sq_personal m WHERE m.codesqpuesto = ((SELECT f.codsqpuesto FROM sq_organigrama f INNER JOIN sq_personal t ON t.codesqpuesto = f.organisup WHERE t.codsqpersonal = '" + iduser + "')))) HAVING ORDEN >13 AND ORDEN<21 ORDER BY a.codsqrespreg, b.ordenpregunta", sqlCon);
                    MySqlDataAdapter ds = new MySqlDataAdapter();
                    ds.SelectCommand = command;
                    ds.Fill(dt);
        ...
        public DataTable PROM613(string iduser)
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand("SELECT a.usuario_calificado,c.ordenpregunta,CAST(AVG(b.nota) AS DECIMAL(10,0)) as promedio2 FROM sq_resultadopregunta a INNER JOIN sq_calificaciones b   INNER JOIN sq_preguntas c ON b.codsqcalificacion=a.resultado AND a.codsqpregunta=c.codsqpregunta WHERE a.usuario_calificado='" + iduser + "' GROUP BY a.codsqpregunta, a.usuario_calificado HAVING ((`ordenpregunta` > 5) AND (`ordenpregunta` < 21)) ORDER BY c.ordenpregunta", sqlCon);
                    MySqlDataAdapter ds = new MySqlDataAdapter();
                    ds.SelectCommand = command;
                    ds.Fill(dt);
        ...
        public DataTable PROM1420(string iduser)
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand("SELECT a.usuario_calificado,c.ordenpregunta,CAST(AVG(b.nota) AS DECIMAL(10,0)) as promedio3 FROM sq_resultadopregunta a INNER JOIN sq_calificaciones b   INNER JOIN sq_preguntas c ON b.codsqcalificacion=a.resultado AND a.codsqpregunta=c.codsqpregunta WHERE a.usuario_calificado='" + iduser + "' GROUP BY a.codsqpregunta, a.usuario_calificado HAVING ((`ordenpregunta` > 13) AND (`ordenpregunta` < 21)) ORDER BY c.ordenpregunta", sqlCon);
                    MySqlDataAdapter ds = new MySqlDataAdapter();
                    ds.SelectCommand = command;
                    ds.Fill(dt);
        ...
        public DataTable COMENT(string iduser)
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand(" select `b`.`ordenpregunta` AS `ORDEN`,`a`.`codsquser` AS `EVALUADOR`,`a`.`usuario_calificado` AS `EVALUADO`,`b`.`pregunta` AS `pregunta`,`a`.`respuesta_texto` AS `respuesta_texto` from ((`bdkbguadalupana`.`sq_resultadopregunta` `a` join `bdkbguadalupana`.`sq_preguntas` `b` on((`a`.`codsqpregunta` = `b`.`codsqpregunta`))) join `bdkbguadalupana`.`sq_calificaciones` `c` on((`c`.`codsqcalificacion` = `a`.`resultado`))) where ((`a`.`usuario_calificado` = '" + iduser + "') and (`a`.`codsquser` = (select `m`.`codsqpersonal` from `bdkbguadalupana`.`sq_personal` `m` where (`m`.`codesqpuesto` = (select `f`.`codsqpuesto` from (`bdkbguadalupana`.`sq_organigrama` `f` join `bdkbguadalupana`.`sq_personal` `t` on((`t`.`codesqpuesto` = `f`.`organisup`))) where (`t`.`codsqpersonal` = '" + iduser + "')))))) having ((`ORDEN` > 20) and (`ORDEN` < 24)) order by `a`.`codsqrespreg`,`b`.`ordenpregunta`", sqlCon);
                    MySqlDataAdapter ds = new MySqlDataAdapter();
                    ds.SelectCommand = command;
                    ds.Fill(dt);
