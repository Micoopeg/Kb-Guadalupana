...
{
    public partial class MantenimientoPrestamos : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            RPCodigo.Value = logic.siguiente("ep_tipoprestamo", "codeptipoprestamo");
        ...
        {
            MySqlDataAdapter ad = new MySqlDataAdapter("SELECT * FROM ep_tipoprestamo;", conn.conectar());
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                string QueryString = "SELECT * FROM ep_tipoprestamo WHERE ep_tipoprestamonombre='" + TextBox1.Text + "';";
                MySqlDataAdapter myCommand = new MySqlDataAdapter(QueryString, conn.conectar());
                DataTable ds3 = new DataTable();
                myCommand.Fill(ds3);
                gvPhoneBook.DataSource = ds3;
