<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AsignacionRolArea.aspx.cs" Inherits="KB_Guadalupana.Views.Sesion.AsignacionRolArea" %>
...
<body>
 ...
 <div >
     <div class="encabezado">
         <h2 class="fs-title">
            <b>Control áreas y roles</b>
        </h2>
        <img src="../../Imagenes/Logotipo-Guadalupana1.png" style="width: 180px; height: 120px; top: 0; margin-left: 0px;" />
     </div>

  <div class="buscar">
    <asp:TextBox ID="TextBox1" placeholder="Ingrese usuario" runat="server" CssClass="tamp"></asp:TextBox>
    ...
    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Ver todos" CssClass="tam" />
        ...
        <br />
            <asp:GridView ID="gvPhoneBook" CssClass="tabla" runat="server" AutoGenerateColumns="false" ShowFooter="false" DataKeyNames="codgenusuario"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Código">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="txtFirstName" Text='<%# Eval("codgenusuario") %>' runat="server" />
                        </EditItemTemplate>
                    </asp:TemplateField>
                          <asp:TemplateField HeaderText="Usuario">
                  <ItemTemplate>
                            <asp:Label Text='<%# Eval("gen_usuarionombre") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtContact" Text='<%# Eval("gen_usuarionombre") %>' runat="server" />
                        </EditItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Área">
                  <ItemTemplate>
                            <asp:Label Text='<%# Eval("gen_area_codgenarea") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtContact2" Text='<%# Eval("gen_area_codgenarea") %>' runat="server" />
                        </EditItemTemplate>
                    </asp:TemplateField>
                      <asp:TemplateField HeaderText="Rol">
                  <ItemTemplate>
                            <asp:Label Text='<%# Eval("gen_roles_codgenroles") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtContact3" Text='<%# Eval("gen_roles_codgenroles") %>' runat="server" />
                        </EditItemTemplate>
                    </asp:TemplateField>
