...
<body style="background-color:#000B1C">
  ...
  <div class="row">
    <div class="col-sm-4" >
        <asp:LinkButton ID="LinkButton1" class="btn btn-success" style=" background-color:#003561; border-color:#003561; text-decoration:none; width:100%" value="Menu Principal" type="button" runat="server" tabindex="25" name="Guardar" title="Guardar" OnClick="btnmenuprincipal_Click" >Menu Principal</asp:LinkButton>
    </div>
    <div class="col-sm-4">
        <center>
