<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRM_Mantfrasesdeldia.aspx.cs" Inherits="CRM_Guadalupana.Views.CRM_SISTEMA.Administracion.Mantenimientos.CRM_Mantfrasesdeldia" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Mantenimiento Tipo de servicio</title>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-8">
      <h3>REGISTROS</h3>
        <asp:Label runat="server">Frases del dia:</asp:Label><input runat="server" id="txtbusqueda" placeholder="BUSCAR POR NOMBRE" style="margin-left:2%" /><asp:LinkButton runat="server" style="margin-left:2%; border-style:none; color:white" ID="btnbuscar" OnClick="btnbuscar_Click">Buscar</asp:LinkButton><br />
    ...
    AutoGenerateColumns="False" OnSelectedIndexChanged = "OnSelectedIndexChangedmantenimiento" BorderStyle="Solid" Width="100%" AllowPaging="True" OnPageIndexChanging="gridviewmantenimiento_PageIndexChanging" PageSize="3" >                 
                     <Columns>
                         <asp:TemplateField HeaderText="Correlativo">
                           <ItemTemplate>
                            <asp:Label ID="lblcodigo" Text='<%# Eval("idcrm_frasesdeldia") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                         <asp:TemplateField HeaderText="Frase - Descripción">
                           <ItemTemplate>
                            <asp:Label ID="lblnombre" Text='<%# Eval("crm_frasesdeldianombre") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>                         
