<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MantenimientoPrestamos.aspx.cs" Inherits="KB_Guadalupana.Views.Sesion.MantenimientoPrestamos" %>
...
<body>
   ...
   <div class="buscar">
    <asp:TextBox ID="TextBox1" placeholder="Ingrese tipo prestamo" runat="server" CssClass="tamp"></asp:TextBox>
    ...
    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Ver todos" CssClass="tam" />
     ...
     <asp:GridView ID="gvPhoneBook" CssClass="tabla" runat="server" AutoGenerateColumns="false" ShowFooter="true" DataKeyNames="codeptipoprestamo"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Código">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("codeptipoprestamo") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtFirstName" Text='<%# Eval("codeptipoprestamo") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtFirstNameFooter" runat="server"/>
                        </FooterTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Tipo Prestamo">
                  <ItemTemplate>
                            <asp:Label Text='<%# Eval("ep_tipoprestamonombre") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtContact" Text='<%# Eval("ep_tipoprestamonombre") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtContactFooter" placeholder="Ingrese tipo prestamo" runat="server" />
                        </FooterTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <ItemTemplate>
