<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Seguridad.aspx.cs" Inherits="KB_Guadalupana.Views.Hallazgos.Seguridad" %>
  ...
  <div class="inset">
      <div class="row">
        <p class="col-md-6">
          ...
          <p class="col-md-3">
            <label style="color:white">Puesto</label>
              <select id="puestos" runat="server" class="dis">
        ...
        <p class="col-md-3">
            ...
            <asp:DropDownList id="usuario" runat="server" class="dis" AutoPostBack="true" ></asp:DropDownList>
        </p>
           <p class="col-md-3">
            <label style="color:white">Rol</label>
              <select id="roles" runat="server" class="dis">
          ...
          <p class="col-md-6">
           <input type="button" id="guardar"  class="button" Value="Asignar" runat="server" name="next" onclick="Guardar()"/>
        </p>
</div>
  </div>
        <asp:LinkButton ID="guardarinformacion" runat="server" OnClick="Guardar_Hallazgo_Click" ClientIDMode="Static"></asp:LinkButton>
          ...
          <asp:GridView ID="GridViewReporteH" CssClass="mGrid" style="width: 950px;text-align:center;text-decoration: none;Color: white;" runat="server"  HeaderStyle-ForeColor="White"
    AutoGenerateColumns="False" BorderStyle="Solid" >
                     <Columns>
                          <asp:TemplateField ControlStyle-CssClass="diseño"  HeaderText="ID">
                        <ItemTemplate>
                           <asp:Label ID="idhallazgo" Text='<%# Eval("id_shpermisos") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField ControlStyle-CssClass="diseño"  HeaderText="Area">
                        <ItemTemplate>
                           <asp:Label ID="lblrubros" Text='<%# Eval("sh_areanombre") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                     <asp:TemplateField ControlStyle-CssClass="diseño"  HeaderText="Usuario">
                        <ItemTemplate>
                           <asp:Label ID="lblrubross" Text='<%# Eval("gen_usuarionombre") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                  <asp:TemplateField ControlStyle-CssClass="diseño"  HeaderText="Rol">
                        <ItemTemplate>
                           <asp:Label ID="lblrubrosss" Text='<%# Eval("Rol") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                     </Columns>
