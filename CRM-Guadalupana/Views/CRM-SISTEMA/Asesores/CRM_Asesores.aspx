...
<%-- AREA DE SEGUIMIENTOS --%>
   ...
   <hr style="border:groove" />   
     ...
     <center>
       <input id="txtdpireferencia" onkeypress="return numeros(event);" style="margin-left:1%;" placeholder="Dpi de referencia" runat="server" type="text" tabindex="18" class="inputscortos"  autofocus />
         </center>
...
<HeaderStyle BackColor="#0084F7" CssClass="prueba" ForeColor="White"></HeaderStyle>
                ...
                <ItemTemplate>
                    <asp:Label ID ="lbl1" runat="server" Text='<%# Eval("crmcontacto_llamadasnombre") %>'></asp:Label>
                </ItemTemplate>
            </asp:Repeater>                
          </center>          
      </div>
