<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MantenimientoInmueble.aspx.cs" Inherits="KB_Guadalupana.Views.Sesion.MantenimientoInmueble" %>
...
<body>
    ...
    <a class="button button5" style="right: 8%;position: absolute;margin-top: -500px;" target="_blank" href="Ayudas/AyudaInmuebles.aspx" ><i class="fa fa-question"></i></a>
    ...
    <form id="form1" runat="server">
     ...
     <div class="encabezado">
         <h2 class="fs-title" style="margin-left:0">
            <b>Registro Tipo Inmueble</b>
        </h2>
        <img src="../../Imagenes/Logotipo-Guadalupana1.png" style="width: 180px; height: 120px; top: 0; margin-left: 0px;" />
     </div>

    <input id="RICodigo" disabled="disabled" readonly="readonly" runat="server" type="text" class="tam" style="width:10%;" maxlength="15" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required/>
    <div class="buscar">
    <asp:TextBox ID="TextBox1" runat="server" placeholder="Ingrese tipo inmueble" CssClass="tamp"></asp:TextBox>
    ...
    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Ver todos" CssClass="tam" />
      ...
      <asp:GridView ID="gvPhoneBook" CssClass="tabla" runat="server" AutoGenerateColumns="false" ShowFooter="true" DataKeyNames="codeptipoinmueble"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Código">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("codeptipoinmueble") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtFirstName" Text='<%# Eval("codeptipoinmueble") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtFirstNameFooter" runat="server"/>
                        </FooterTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Tipo de Inmueble">
                  <ItemTemplate>
                            <asp:Label Text='<%# Eval("ep_tipoinmueblenombre") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtContact" Text='<%# Eval("ep_tipoinmueblenombre") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtContactFooter" placeholder="Ingrese tipo inmueble" runat="server" />
                        </FooterTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <ItemTemplate>
