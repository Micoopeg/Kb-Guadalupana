...
{
    public partial class CertificacionJuridicoEnviados : System.Web.UI.Page
    {
        ...
        protected void Actualizar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                sn.cambiarestadoenviado(numcredito, "3");
        ...
        protected void Desasignar_Click(object sender, EventArgs e)
        {
            ...
            sn.cambiarestadodesasignado(numcredito, "3");
            string tipocredito = Session["TipoCredito"] as string;
            string tabla = "";
            string fecha;
            ...
            string sig5 = sn.siguiente("pj_bitacora", "idpj_bitacora");
            sn.insertarbitacora(sig5, NumIncidente.Value, numcredito, NombreCliente.Value, "Desasignado", "34", "51", fechahoraactual, fechacreacion2, ObservacionesCredito.Value);
