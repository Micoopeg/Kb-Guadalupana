...
namespace CRM_Guadalupana.Views.CRM_SISTEMA.Agenda
{
    public partial class CRM_Agenda : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
           ...
           //     string datoausar = Desencriptar(var);
        ...
        protected void btnagendar_Click(object sender, EventArgs e)
        {
            ...
            if (txtcodigo.Value == "" || txtencabezado.Value == "" || txtfechafin.Value == "" ||
            ...
            else
            {
                ...
                string[] valores = {sig1,txtcodigo.Value,txtfechafin.Value,txtfechafin.Value,
