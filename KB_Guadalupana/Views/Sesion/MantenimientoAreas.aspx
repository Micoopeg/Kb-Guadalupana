<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MantenimientoAreas.aspx.cs" Inherits="KB_Guadalupana.Views.Sesion.MantenimientoAreas" %>
...
<body>
 ...
 <div >
  ...
  <div class="buscar">
    <asp:TextBox ID="TextBox1" placeholder="Ingrese nombre de área" runat="server" CssClass="tamp"></asp:TextBox>
    ...
    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Ver todos" CssClass="tam" />
        ...
        <br />
            <asp:GridView ID="gvPhoneBook" CssClass="tabla" runat="server" AutoGenerateColumns="false" ShowFooter="true" DataKeyNames="codgenarea"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Código">
                        <ItemTemplate>
                            <asp:Label  Text='<%# Eval("codgenarea") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtFirstName" Text='<%# Eval("codgenarea") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                      ...
                      <asp:TemplateField HeaderText="No. Sucursal">
                        <ItemTemplate>
                            <asp:Label  Text='<%# Eval("codgensucursal") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtContact" Text='<%# Eval("codgensucursal") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtContactFooter" placeholder="Ingrese no. de sucursal" runat="server" />
                           <%-- <asp:TextBox ID="TextBox2" ReadOnly="true" runat="server"/>--%>
                        </FooterTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Área">
                  <ItemTemplate>
                            <asp:Label Text='<%# Eval("gen_areanombre") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtContact2" Text='<%# Eval("gen_areanombre") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtContactFooter2" placeholder="Ingrese área" runat="server" />
                        </FooterTemplate>
                    </asp:TemplateField>
