    ...
    <form id="form1" runat="server">
        <div class="general">
            <div class="formularioCobros">
                <div>
                    <input id="NumCredito" runat="server" type="number" min="0" class="formatoinput2" placeholder="Ingrese no. crédito" maxlength="11" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" />

                    <label class="titulos"><b>Fecha de asignación</b></label>
                    <input id="PrimerApellido" runat="server" type="Date" class="formatoinput2" />
                </div>
                <div style="overflow: auto; height: 300px">
                        <asp:GridView ID="gridViewAsignacion" runat="server" CssClass="tabla" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <ItemTemplate>
                                       <asp:Label ID="lblestado" Text='<%# Eval("gen_estadoasignacion") %>' runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
