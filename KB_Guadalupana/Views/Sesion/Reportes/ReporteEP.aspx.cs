...
namespace KB_Guadalupana.Views.Sesion.Reportes
{
    public partial class ReporteEP : System.Web.UI.Page
    {
        ...
        public void mostrarInventario()
        {
            ...
            MySqlDataReader mostrar = logic.consultarInv("ep_informaciongeneral", "codepinformaciongeneralcif", cifnumero);
            try
            {
                if (mostrar.Read())
                {
        ...
        public void mostrarmaquinaria()
        {
            ...
            MySqlDataReader mostrar = logic.consultarmaquinaria("ep_informaciongeneral", "codepinformaciongeneralcif", cifnumero);
            try
            {
                if (mostrar.Read())
                {
        ...
        public void mostrarmenaje()
        {
            ...
            MySqlDataReader mostrar = logic.consultarmenaje("ep_informaciongeneral", "codepinformaciongeneralcif", cifnumero);
            try
            {
                if (mostrar.Read())
                {
        ...
        public void mostrarmenaje1()
        {
            ...
            MySqlDataReader mostrar = logic.consultarmenaje1("ep_informaciongeneral", "codepinformaciongeneralcif", cifnumero);
            try
            {
                if (mostrar.Read())
                {
        ...
        public void mostrarmenaje2()
        {
            ...
            MySqlDataReader mostrar = logic.consultarmenaje2("ep_informaciongeneral", "codepinformaciongeneralcif", cifnumero);
            try
            {
                if (mostrar.Read())
                {
        ...
        public void mostrarTV()
        {
            ...
            MySqlDataReader mostrar = logic.consultarTV("ep_informaciongeneral", "codepinformaciongeneralcif", cifnumero);
            try
            {
                if (mostrar.Read())
                {
        ...
        public void mostrarES()
        {
            ...
            MySqlDataReader mostrar = logic.consultarES("ep_informaciongeneral", "codepinformaciongeneralcif", cifnumero);
            try
            {
                if (mostrar.Read())
                {
        ...
        public void mostrarL()
        {
            ...
            MySqlDataReader mostrar = logic.consultarL("ep_informaciongeneral", "codepinformaciongeneralcif", cifnumero);
            try
            {
                if (mostrar.Read())
                {
        ...
        public void mostrarSec()
        {
            ...
            MySqlDataReader mostrar = logic.consultarSec("ep_informaciongeneral", "codepinformaciongeneralcif", cifnumero);
            try
            {
                if (mostrar.Read())
                {
        ...
        public void mostrarEstufa()
        {
            ...
            MySqlDataReader mostrar = logic.consultarEst("ep_informaciongeneral", "codepinformaciongeneralcif", cifnumero);
            try
            {
                if (mostrar.Read())
                {
        ...
        public void mostrarRefri()
        {
            ...
            MySqlDataReader mostrar = logic.consultarRefri("ep_informaciongeneral", "codepinformaciongeneralcif", cifnumero);
            try
            {
                if (mostrar.Read())
                {
        ...
        public void mostrarTel()
        {
            ...
            MySqlDataReader mostrar = logic.consultarTel("ep_informaciongeneral", "codepinformaciongeneralcif", cifnumero);
            try
            {
                if (mostrar.Read())
                {
        ...
        public void mostrarOtros()
        {
            ...
            MySqlDataReader mostrar = logic.consultarOtros("ep_informaciongeneral", "codepinformaciongeneralcif", cifnumero);
            try
            {
                if (mostrar.Read())
                {
        ...
        public void mostrarOtrasDeudas()
        {
            ...
            MySqlDataReader mostrar = logic.consultarOD("ep_informaciongeneral", "codepinformaciongeneralcif", cifnumero);
            try
            {
                if (mostrar.Read())
                {
        ...
        public void mostrarPasivoC()
        {
            ...
            MySqlDataReader mostrar = logic.consultarmostrarPC("ep_informaciongeneral", "codepinformaciongeneralcif", cifnumero);
            try
            {
                if (mostrar.Read())
                {
        ...
        public void mostrarIngresos()
        {
            ...
            MySqlDataReader mostrar = logic.consultarmostrarIng("ep_informaciongeneral", "codepinformaciongeneralcif", cifnumero);
            try
            {
                if (mostrar.Read())
                {
        ...
        public void mostrarNegocio()
        {
            ...
            MySqlDataReader mostrar = logic.consultarmostrarNeg("ep_informaciongeneral", "codepinformaciongeneralcif", cifnumero);
            try
            {
                if (mostrar.Read())
                {
        ...
        public void mostrarRemesas()
        {
            ...
            MySqlDataReader mostrar = logic.consultarmostrarRem("ep_informaciongeneral", "codepinformaciongeneralcif", cifnumero);
            try
            {
                if (mostrar.Read())
                {
        ...
        public void mostrarEgresos()
        {
            ...
            MySqlDataReader mostrar = logic.consultarmostrarEgres("ep_informaciongeneral", "codepinformaciongeneralcif", cifnumero);
            try
            {
                if (mostrar.Read())
                {
