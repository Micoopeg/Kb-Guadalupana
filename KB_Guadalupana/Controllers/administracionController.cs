...
namespace borrar01.Controllers
{
    public class administracionController : Controller
    {
        ...
        public ActionResult vistaroles(List<roles> items)
        {
            ...
            {
                case "1":
                    query3 = "SELECT * FROM tes_rol_list order by rol_nom";
                    break;

                case "2":
                    query3 = "SELECT * FROM tes_rol_list where id_rol ='"+d4+ "' order by rol_nom";
                    break;
                case "10":
                    query3 = "SELECT * FROM bd_seguridad.tes_rol_list where id_are ='" + d3 + "' order by rol_nom";
                    break;
        ...
        public ActionResult datossucursal(List<sucursales> items)
        {
            ...
            {
                case "1":
                    query3 = "SELECT * FROM tes_suc_list order by suc_nom";
                    break;

                case "2":
                    query3 = "SELECT * FROM tes_suc_list where id_reg ='" + d6 + "' order by suc_nom";
                    break;
            }
        ...
        public ActionResult datosarea(List<area> items)
        {
            ...
            {
                case "1":
                    query3 = "SELECT * FROM tes_are_lis order by nom_are asc";
                    break;

                case "2":
                    query3 = "SELECT * FROM tes_are_lis where id_reg ='" + d4 + "' order nom_are asc";
                    break;
            }
