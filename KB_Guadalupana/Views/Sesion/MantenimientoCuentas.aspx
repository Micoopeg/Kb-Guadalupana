<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MantenimientoCuentas.aspx.cs" Inherits="KB_Guadalupana.Views.Sesion.MantenimientoCuentas" %>
...
<body>
    ...
    <a class="button button5" style="right: 8%;position: absolute;margin-top: -500px;" target="_blank" href="Ayudas/AyudaCuentas.aspx" ><i class="fa fa-question"></i></a>
  ...
  <div>
   <div class="encabezado">
         <h2 class="fs-title" style="margin-left:0">
            <b>Registro Tipo Cuentas</b>
        </h2>
        <img src="../../Imagenes/Logotipo-Guadalupana1.png" style="width: 180px; height: 120px; top: 0; margin-left: 0px;" />
    </div>
    <input id="RCCodigo" disabled="disabled" readonly="readonly" runat="server" type="text" class="tampe" style="width:10%;" maxlength="15" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required/>
  
   <div class="buscar">
    <asp:TextBox ID="TextBox1" placeholder="Ingrese tipo cuenta" runat="server" CssClass="tamp"></asp:TextBox>
 ...
 <asp:GridView ID="gvPhoneBook" CssClass="tabla" runat="server" AutoGenerateColumns="false" ShowFooter="true" DataKeyNames="codeptipocuenta"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Código">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("codeptipocuenta") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtFirstName" Text='<%# Eval("codeptipocuenta") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                  ...
                  <ItemTemplate>
                            <asp:Label Text='<%# Eval("ep_tipocuentanombre") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtContact" Text='<%# Eval("ep_tipocuentanombre") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtContactFooter" placeholder="Ingrese tipo cuenta" runat="server" />
                        </FooterTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <ItemTemplate>
